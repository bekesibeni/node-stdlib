...
export interface Promises {
    ...
    callbackPromise: (callbackArgs: string[] | null, callback: null | ((...args: any[]) => void), isOptional: boolean, executor: (resolve: (value: any) => void, reject: (err: any) => void) => void) => Promise<any>;
    timeoutCallbackPromise: (timeout: number, callbackArgs: string[] | null, callback: null | ((...args: any[]) => void), isOptional: boolean, executor: (resolve: (value: any) => void, reject: (err: any) => void) => void) => Promise<any>;
    retryPromise: (attempts: number, delayBetweenAttempts: number, executor: (resolve: (value: any) => void, reject: (err: any) => void) => void) => Promise<any>;
