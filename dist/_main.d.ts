...
export { Arrays, Concurrency, DataStructures, Hashing, HTTP, IPv4, Objects, OS, Parsing, Promises, Rendering, Time, Units, UUID };
declare const _default: {
    ...
    UUID: import("./lib/_meta/module-types").UUID;
};
